...
use ERP\GameBundle\Entity\Region;
use ERP\GameBundle\Form\RegionType;
...
class RegionController extends Controller
{
     ...
     * @Method("POST")
     * @Template("ERPGameBundle:Region:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ERPGameBundle:Region')->find($id);
     ...
     * @Method("PUT")
     * @Template("ERPGameBundle:Region:edit.html.twig")
     */
