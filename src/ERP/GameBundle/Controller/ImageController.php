...
use ERP\GameBundle\Form\ImageType;
...
class ImageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ERPGameBundle:Image')->findAll();
     ...
     * @Method("POST")
     * @Template("ERPGameBundle:Image:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ERPGameBundle:Image')->find($id);
     ...
     * @Method("PUT")
     * @Template("ERPGameBundle:Image:edit.html.twig")
     */
