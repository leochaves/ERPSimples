...
class Builder extends ContainerAware {
    ...
    public function responsiveNavbar(FactoryInterface $factory, array $options) {
        ...
        $item = $menu->addChild('Inicio', array('route' => 'game'));
       // $item->setCurrent(true);
        $games = $menu->addChild('Games');
        $games->addChild('.icon-list-alt Listar Games', array('route' => 'game'));
        $games->addChild('.icon-plus Adicionar Game', array('route' => 'game_new'));
 
        $console = $menu->addChild('Console');
        $console->addChild('.icon-list-alt Listar Consoles', array('route' => 'console'));
        $console->addChild('.icon-plus Adicionar Console', array('route' => 'console_new'));
